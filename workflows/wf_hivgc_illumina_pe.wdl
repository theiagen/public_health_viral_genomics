...
import "../tasks/task_hiv_alignment.wdl" as align
import "../tasks/task_hiv_consensus_call.wdl" as consensus_call
...
workflow hivgc_illumina_pe {
  ...
  call taxon_ID.quasitools_illumina_pe as quasitools {
    input:
      samplename = samplename,
      read1 = read1_raw,
      read2 = read2_raw
