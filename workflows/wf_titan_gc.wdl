        ...
        if (sample.titan_wf == "clearlabs") {
           ...
           call summary.titan_summary as clearlabs_summary {
                input:
                    ...
                    s_gene_mean_coverage = titan_clearlabs.s_gene_mean_coverage,
                    ...
                    fastq_scan_clean1 = titan_clearlabs.fastq_scan_clean,
                    fastq_scan_raw1 = titan_clearlabs.fastq_scan_raw,
                    fastq_scan_version = titan_clearlabs.fastq_scan_version,
                    ...
                    artic_pipeline_docker = titan_clearlabs.artic_pipeline_docker,
        ...
        if (sample.titan_wf == "illumina_pe") {
           ...
           call summary.titan_summary as illumina_pe_summary {
                input:
                    ...
                    s_gene_mean_coverage = titan_illumina_pe.s_gene_mean_coverage,
                    ...
                    fastq_scan_clean1 = titan_illumina_pe.fastq_scan_clean1,
                    fastq_scan_clean2 = titan_illumina_pe.fastq_scan_clean2,
                    fastq_scan_clean_pairs = titan_illumina_pe.fastq_scan_clean_pairs,
                    fastq_scan_raw1 = titan_illumina_pe.fastq_scan_raw1,
                    fastq_scan_raw2 = titan_illumina_pe.fastq_scan_raw2,
                    fastq_scan_raw_pairs = titan_illumina_pe.fastq_scan_raw_pairs,
                    ...
                    fastq_scan_version = titan_illumina_pe.fastq_scan_version,
        ...
        if (sample.titan_wf == "illumina_se") {
            ...
            call summary.titan_summary as illumina_se_summary {
                input:
                    ...
                    s_gene_mean_coverage = titan_illumina_se.s_gene_mean_coverage,
                    ...
                    fastq_scan_clean1 = titan_illumina_se.fastq_scan_clean,
                    fastq_scan_raw1 = titan_illumina_se.fastq_scan_raw,
        ...
        if (sample.titan_wf == "ont") {
            ...
            call summary.titan_summary as ont_summary {
                input:
                    ...
                    s_gene_mean_coverage = titan_ont.s_gene_mean_coverage,
                    ...
                    fastq_scan_clean1 = titan_ont.fastq_scan_clean,
                    fastq_scan_raw1 = titan_ont.fastq_scan_raw,
                    fastq_scan_version = titan_ont.fastq_scan_version,
                    ...
                    artic_pipeline_docker = titan_ont.artic_pipeline_docker,
