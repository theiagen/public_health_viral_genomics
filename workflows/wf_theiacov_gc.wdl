    ...
    if (sample.theiacov_wf == "clearlabs") {
      ...
      call summary.theiacov_summary as clearlabs_summary {
        input:
          ...
          consensus_n_variant_min_depth = theiacov_clearlabs.consensus_n_variant_min_depth,
    ...
    if (sample.theiacov_wf == "ont") {
      ...
      call summary.theiacov_summary as ont_summary {
        input:
          ...
          consensus_n_variant_min_depth = theiacov_ont.consensus_n_variant_min_depth,
