    ...
    if (sample.theiacov_wf == "clearlabs") {
      ...
      call summary.theiacov_summary as clearlabs_summary {
        input:
          ...
          fastq_scan_clean1 = theiacov_clearlabs.fastq_scan_clean,
          fastq_scan_raw1 = theiacov_clearlabs.fastq_scan_raw,
    ...
    if (sample.theiacov_wf == "illumina_pe") {
      ...
      call summary.theiacov_summary as illumina_pe_summary {
        input:
          ...
          fastq_scan_clean1 = theiacov_illumina_pe.fastq_scan_clean1,
          fastq_scan_clean2 = theiacov_illumina_pe.fastq_scan_clean2,
          fastq_scan_clean_pairs = theiacov_illumina_pe.fastq_scan_clean_pairs,
          fastq_scan_raw1 = theiacov_illumina_pe.fastq_scan_raw1,
          fastq_scan_raw2 = theiacov_illumina_pe.fastq_scan_raw2,
          fastq_scan_raw_pairs = theiacov_illumina_pe.fastq_scan_raw_pairs,
    ...
    if (sample.theiacov_wf == "illumina_se") {
      ...
      call summary.theiacov_summary as illumina_se_summary {
        input:
          ...
          fastq_scan_clean1 = theiacov_illumina_se.fastq_scan_clean,
          fastq_scan_raw1 = theiacov_illumina_se.fastq_scan_raw,
    ...
    if (sample.theiacov_wf == "ont") {
      ...
      call summary.theiacov_summary as ont_summary {
        input:
          ...
          fastq_scan_clean1 = theiacov_ont.fastq_scan_clean,
          fastq_scan_raw1 = theiacov_ont.fastq_scan_raw,
