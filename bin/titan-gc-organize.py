...
OUTPUTS = {
    ...
    'assembly_fasta': {'ext': ['.ivar.consensus.fasta', '.medaka.consensus.fasta', '.fasta'], 'folder': 'assemblies'},
    'auspice_json': {'ext': ['.ivar.consensus.nextclade.auspice.json', '.medaka.consensus.nextclade.auspice.json', '.nextclade.auspice.json'], 'folder': 'nextclade'},
    ...
    'nextclade_json': {'ext': ['.ivar.consensus.nextclade.json', '.medaka.consensus.nextclade.json', '.nextclade.json'], 'folder': 'nextclade'},
    'nextclade_tsv': {'ext': ['.ivar.consensus.nextclade.tsv', '.medaka.consensus.nextclade.tsv', '.nextclade.tsv'], 'folder': 'nextclade'},
    'pango_lineage_report': {'ext': ['.pangolin_report.csv'], 'folder': 'pangolin_reports'},
    'vadr_alerts_list': {'ext': ['.ivar.consensus.vadr.alt.list', '.medaka.consensus.vadr.alt.list', '.vadr.alt.list'], 'folder': 'vadr_alerts'},
