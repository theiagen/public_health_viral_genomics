...
These workflows were written to ingest and properly format all suggested metadata fields as per the `Public Health Alliance for Genomic Epidemiology's SARS-CoV-2 Contextual Data Specifications,<https://github.com/pha4ge/SARS-CoV-2-Contextual-Data-Specification>`.
